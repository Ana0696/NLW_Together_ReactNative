...
import { ImageBackground, Text, View,Alert, FlatList, Platform, Share, Linking } from "react-native";
...
export function AppointmentDetails() {
    ...
    async function fetchGuildWidget() {
        try{
            ...
            Alert.alert('Verifique as configurações do servidor. Será que i Widget está habilitado?')
        } finally{
            setLoading(false);
        }
    }
